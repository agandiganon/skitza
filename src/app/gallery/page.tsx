        ...
        <section className="cv-auto px-4 pb-4">
          <div className="mx-auto max-w-6xl rounded-[2rem] border border-blue-100 bg-white/90 p-6 text-center shadow-[0_22px_60px_-42px_rgba(15,23,42,0.36)] sm:p-8">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-foreground/75 sm:text-lg">
              אם מצאתם כיוון שמתאים למותג או למוצר שלכם, השלב הבא הוא להשאיר פרטים ולהסביר
              בקצרה מה צריך לתכנן, לעצב או לייצר.
            </p>
            <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link
                ...
                className="inline-flex min-h-[48px] items-center justify-center rounded-2xl bg-gradient-to-l from-accent-cyan via-blue-500 to-primary px-7 py-3 text-base font-semibold text-white shadow-lg transition hover:-translate-y-0.5 hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
              >
              ...
              <Link
                ...
                className="inline-flex min-h-[48px] items-center justify-center rounded-2xl border border-blue-200 bg-white px-7 py-3 text-base font-semibold text-primary shadow-sm transition hover:border-blue-300 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
              >
