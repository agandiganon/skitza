            ...
            <div className="relative z-[1] grid gap-8 lg:grid-cols-[minmax(250px,0.9fr)_minmax(0,1.85fr)] lg:items-center lg:gap-10">
              ...
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 xl:grid-cols-5">
                {CLIENT_LOGOS.map((logo, index) => (
                  <AnimatedSection key={logo.id} delay={index * 0.03}>
                    <div className="partners-logo-card group flex h-[88px] items-center justify-center overflow-hidden rounded-[1.45rem] border border-slate-200/75 bg-white/94 px-4 py-3 sm:h-[94px] sm:px-5 lg:h-[102px]">
