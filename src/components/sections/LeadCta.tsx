    ...
    <section className="cv-auto px-4 py-12 sm:py-14 lg:py-16">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-[2.3rem] border border-blue-100/70 bg-[linear-gradient(135deg,_rgba(13,47,102,1),_rgba(24,76,172,0.96)_55%,_rgba(34,197,234,0.78))] p-6 text-white shadow-[0_32px_92px_-50px_rgba(15,23,42,0.58)] sm:p-8 lg:p-10">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.95fr)] lg:items-center">
          <div>
            <p className="text-sm font-black tracking-[0.24em] text-cyan-100/82 uppercase">
              מתחילים מסודר
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link
                ...
                className="text-primary inline-flex min-h-[50px] items-center justify-center gap-2 rounded-2xl bg-white px-6 py-3.5 text-base font-semibold shadow-md transition hover:-translate-y-0.5 hover:bg-cyan-50 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-900 focus:outline-none"
              >
                עמוד יצירת קשר
              ...
              <a
                ...
                className="inline-flex min-h-[46px] items-center justify-center rounded-2xl border border-white/18 bg-white/10 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/16 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-900 focus:outline-none"
              >
                וואטסאפ
              </a>
              <a
                ...
                className="inline-flex min-h-[46px] items-center justify-center gap-2 rounded-2xl border border-white/18 bg-white/10 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/16 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-900 focus:outline-none"
              >
