    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-50 px-4 pt-6 pb-16 sm:pt-8 sm:pb-20">
      <div className="mx-auto max-w-6xl">
        ...
        <section className="cv-auto relative overflow-hidden rounded-[2.3rem] border border-blue-100 bg-white/92 px-6 py-10 shadow-[0_30px_90px_-48px_rgba(15,23,42,0.4)] ring-1 ring-blue-100 sm:px-10 sm:py-12">
          <div
            className="service-hero-orbs pointer-events-none absolute inset-0 opacity-30"
            aria-hidden
          />
          <div className="relative mx-auto max-w-4xl text-center">
            <p className="text-sm font-black tracking-[0.28em] text-blue-700/75 uppercase">
              שירותי סקיצה
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-2.5">
              {page.heroPills.map((pill) => (
                <span
                  key={pill}
                  className="text-primary rounded-full border border-blue-100 bg-white/80 px-4 py-2 text-sm font-semibold"
                >
                  {pill}
                </span>
              ))}
        ...
        >
          ...
          {page.valueItems.map((item) => (
            ...
            >
              <div
                className="from-accent-cyan to-primary mb-4 h-1.5 w-16 rounded-full bg-gradient-to-l via-blue-500"
                aria-hidden
              />
              ...
              {page.processSteps.map((step, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <span className="from-accent-cyan to-primary inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-l via-blue-500 text-sm font-black text-white shadow-md">
                      0{index + 1}
                    </span>
                    <div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            {relatedServices.map((relatedService) => (
              <Link
                ...
                className="group focus:ring-primary rounded-[1.45rem] border border-blue-100 bg-blue-50/50 p-5 transition hover:-translate-y-0.5 hover:border-blue-200 hover:bg-white hover:shadow-md focus:ring-2 focus:ring-offset-2 focus:outline-none"
              >
                <h3 className="text-primary text-lg font-bold">
        ...
        <section className="cv-auto from-primary to-primary mt-10 rounded-[2rem] border border-blue-100 bg-gradient-to-l via-blue-800 p-6 text-white shadow-[0_26px_70px_-40px_rgba(15,23,42,0.55)] sm:mt-12 sm:p-8">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-base leading-relaxed text-white/78 sm:text-lg">
                ...
                ונחזור להמשך בירור והתאמת פתרון לפרויקט.
              </p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row lg:justify-end">
              <Link
                ...
                data-track-service={page.key}
                className="text-primary inline-flex min-h-[48px] items-center justify-center rounded-2xl bg-white px-7 py-3 text-base font-semibold shadow-md transition hover:-translate-y-0.5 hover:bg-cyan-50 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-900 focus:outline-none"
              >
              ...
              <Link
                ...
                className="inline-flex min-h-[48px] items-center justify-center rounded-2xl border border-white/25 bg-white/10 px-7 py-3 text-base font-semibold text-white transition hover:bg-white/16 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-900 focus:outline-none"
              >
                מעבר לשירות משלים
              </Link>
            </div>
