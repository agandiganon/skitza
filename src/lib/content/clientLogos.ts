...
const NAME_OVERRIDES: Record<string, string> = {
  '176990742_247384466827013_2134977926166012855_n.jpg': 'מותג קמעונאות',
  ...
  'logo-small.png': 'מותג שותף',
  'logo-transparent.png': 'מותג שותף',
};
...
export const CLIENT_LOGOS: readonly ClientLogo[] = logoFiles.map(
  (filename, index) => {
    const id = filename
      .toLowerCase()
      .replace(/\.[a-z0-9]+$/i, '')
    ...
    return {
      ...
      alt: name.startsWith('לוגו ') ? name : `לוגו ${name}`,
    };
  },
);
